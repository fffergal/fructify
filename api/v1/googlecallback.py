...
def googlecallback():
    ...
    with trace_cm(closing(connection), "db connection"):
        ...
        with trace_cm(connection, "google table maint transaction"):
            with trace_cm(connection.cursor(), "google table maint cursor") as cursor:
        ...
        with trace_cm(connection, "save google token transaction"):
            with trace_cm(connection.cursor(), "save google token cursor") as cursor:
